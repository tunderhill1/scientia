...
export const DayIndicator = ({ weeks, currentDayColumn }: { weeks: number; currentDayColumn: number }) => {
  ...
  const currentDayColumnIsWithinGrid =
    currentDayColumn > 0 && currentDayColumn <= weeks * COLS_IN_WEEK && currentDayColumn % COLS_IN_WEEK !== 0
